...
import psycopg2
# Fetch variables
USER = "postgres.ctlrhsiwermkwaosnjix" #os.getenv("user")
PASSWORD = "supapassword_"# os.getenv("password")
...
if model is not None:
    ...
    if st.button("Predecir Especie"):
        ...
        try:
            ...
            insert_query = """INSERT INTO iris_log (sepal_length, sepal_width, petal_length, petal_width, predicted_species, confidence)
            VALUES (%s, %s, %s, %s, %s, %s)"""
